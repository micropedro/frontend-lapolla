    ...
    return (<Guard>
        <div>
            <div className='flex-between px-4 pt-3'>
                <h2> Quinielas </h2>
                <div>
                    <button onClick={() => { setMenu(1); handler("ayer") }} className="btn text-primary mx-3" > Jugando hoy </button>
                    <button onClick={() => { setMenu(2); handler("hoy") }} className="btn text-primary mx-3" > Nuevos Tickets </button>
                    <button onClick={() => setMenu(3)} className="btn text-primary mx-3" > Listar quinielas </button>
